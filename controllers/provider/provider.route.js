...
router.get(
  "/get_provider/:userId/:email",
  authentication,
  authorization,
  provider.getProviderByUserId
);
...
router.post(
  ...
  authentication,
  authorization,
  provider.saveClients
);
router.get(
  "/saved-client",
  authentication,
  authorization,
  provider.getSaveClients
);
router.delete(
  "/saved-client/:clientId",
  authentication,
  provider.deleteSaveClient
);
router.get(
  "/search-savedClient",
  authentication,
  authorization,
  provider.searchSavedClient
);
router.put(
  "/account-approval",
  authentication,
  authorization,
  provider.updateAccountApproval
);
router.post(
  "/shift-Organisation",
  authentication,
  authorization,
  provider.shiftProviderOrganisation
);
router.get(
  "/hippa-status",
  authentication,
  authorization,
  provider.getAllHippaStatus
);
router.get(
  "/activeProvider",
  authentication,
