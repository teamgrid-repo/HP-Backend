...
router.post(
  "/additional-member",
  authentication,
  userValidator.additionalMember,
  userController.createAdditionalUser
);
router.get(
  "/additional-member",
  authentication,
  userController.getAllAdditionalUser
);
router.put(
  "/additional-member/:providerId/:userId",
  authentication,
  userController.updateSubUsers
);
router.put(
  "/additional-member-provider/:providerId/:userId",
  authentication,
  userController.updateSubUsersProvider
);
router.delete(
  "/additional-member/:providerId",
  authentication,
  userController.deleteSubUsers
);
router.post(
  "/upload-image",
  authentication,
  upload.any(),
  userController.uploadBase64Image
);
router.post(
  "/update_provider/:id",
  authentication,
...
router.get(
  ...
  authentication,
  authorization,
  userController.switchTab
);
//router.post("/add-poc", authentication, userController.createPOC);
router.get(
  "/activeUser",
  authentication,
  authorization,
